...
//
int shake(String Video_Open_Path)
{
    ...
    //VideoCapture cap("./data/Street_Angel/720p_avi/2719_2725.avi");
    VideoCapture cap(Video_Open_Path);
    ...
    while(true) {
        ...
        //        goodFeaturesToTrack(prev_grey, prev_corner, 300, 0.01, 30);
        //        goodFeaturesToTrack(prev_grey, prev_corner, 200, 0.01, 40);
